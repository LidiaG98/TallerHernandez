...
namespace TallerHernandez.Migrations
{
    ...
    [Migration("20200918194812_Recepcion1.0")]
    partial class Recepcion10
    {
            ...
            modelBuilder.Entity("TallerHernandez.Models.Automovil", b =>
                {
                    b.HasOne("TallerHernandez.Models.Recepcion", "recepcion")
                        .WithOne("Automovil")
                        .HasForeignKey("TallerHernandez.Models.Automovil", "RecepcionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TallerHernandez.Models.Cliente", b =>
                {
                    b.HasOne("TallerHernandez.Models.Recepcion", "recepcion")
                        .WithOne("cliente")
                        .HasForeignKey("TallerHernandez.Models.Cliente", "RecepcionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("TallerHernandez.Models.Empleado", b =>
                {
                    b.HasOne("TallerHernandez.Models.Recepcion", "recepcion")
                        .WithOne("empleado")
                        .HasForeignKey("TallerHernandez.Models.Empleado", "RecepcionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
